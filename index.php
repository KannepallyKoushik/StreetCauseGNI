...
$sql=mysqli_query($conn,"select * from slider left join events on slider.event_name=events.id ");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="swiper-container hero-slider">
		...
		<?php 
            ...
            <div class="swiper-slide hero-content-wrap">
                ...
                <img src="admin/boardmembers/<?php echo $res['pic']; ?>" alt="">
                        ...
                        <div class="row h-100">
                            <div class="col-12 col-lg-8 d-flex flex-column justify-content-center align-items-start">
                                ...
                                <div class="entry-content mt-4">
                                    <p><?php echo $res['quote']; ?></p>
                                </div><!-- .entry-content -->

                                <footer class="entry-footer d-flex flex-wrap align-items-center mt-5">
                                    
                                    <a href="<?php echo $res['ref_path']; ?>" class="btn orange-border">Know More</a>
                                </footer><!-- .entry-footer -->
                            </div><!-- .col -->
                        </div><!-- .row -->
                    </div><!-- .container -->
